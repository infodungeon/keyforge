  ...
  return (
    <div className="bg-slate-950 border-b border-slate-800 p-2 flex items-center justify-between text-xs px-4">
      ...
      <div className="flex items-center gap-2">
        <span className="uppercase font-bold text-slate-500 text-[10px] tracking-wider">
          Status:
        </span>
        <div
        ...
        />
        <span
          className={`uppercase font-bold ${status === "connected" ? "text-green-500" : "text-slate-400"}`}
        >
          {status}
        </span>
      </div>
