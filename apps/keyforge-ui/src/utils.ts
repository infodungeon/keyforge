...
export function formatForDisplay(raw: string): string {
  return keycodeService.formatForDisplay(raw);
}
export function toDisplayString(raw: string): string {
  return keycodeService.toDisplayString(raw);
}
export function fromDisplayString(display: string): string {
  return keycodeService.fromDisplayString(display);
}
