...
// Manual implementation to handle [f32; 256] which acts weird with derive in some Rust versions
...
// RENAMED from load_merged_bundle to load_corpus_bundle to fix import error
