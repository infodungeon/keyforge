...
See also: [Basic Keycodes](https://docs.qmk.fm/features/keycodes#basic-keycodes)
...
| `KC_LEFT`                | `KC_LEFT`                       | Left Arrow                              | ✔       | ✔     | ✔         |
| `KC_DOWN`                | `KC_DOWN`                       | Down Arrow                              | ✔       | ✔     | ✔         |
| `KC_UP`                  | `KC_UP`                         | Up Arrow                                | ✔       | ✔     | ✔         |
...
See also: [Quantum Keycodes](https://docs.qmk.fm/features/keycodes#quantum-keycodes)
...
See also: [Wireless](https://docs.qmk.fm/features/bluetooth)
...
See also: [Layer Switching](https://docs.qmk.fm/features/layers#switching-and-toggling-layers)
...
See also: [Magic Keycodes](https://docs.qmk.fm/features/magic)
...
| `QK_MIDI_PORTAMENTO`            | `MI_PORT`          | Portamento                        |
...
See also: [Modifier Keys](https://docs.qmk.fm/features/keycodes#modifier-keys)
...
See also: [Mod-Tap](https://docs.qmk.fm/features/mod_tap)
...
See also: [Dynamic Tapping Term](https://docs.qmk.fm/features/dynamic_tapping_term)
...
See also: [US ANSI Shifted Symbols](https://docs.qmk.fm/features/keycodes#us-ansi-shifted-symbols)
...
See also: [One Shot Keys](https://docs.qmk.fm/features/one_shot_keys)
