...
use utoipa::ToSchema;
use ts_rs::TS;
use super::constants::SCORE_SCALE;

#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash, PartialOrd, Ord, Serialize, Deserialize, ToSchema, TS)]
#[serde(transparent)]
#[ts(export)]
#[repr(transparent)]
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash, Serialize, Deserialize, ToSchema, Default, TS)]
#[serde(transparent)]
#[ts(export)]
#[repr(transparent)]
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Default, Serialize, Deserialize, ToSchema, TS)]
#[serde(transparent)]
#[ts(export)]
#[repr(transparent)]
